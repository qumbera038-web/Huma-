...
### ۶. جدید صوتی نیویگیشن (Global Voice Command Tab Switching)
- `GlobalVoiceCommand` کو اپ ڈیٹ کیا گیا تاکہ تمام ٹیبز (انوینٹری، بلنگ، کھاتہ، رپورٹس، واٹس ایپ، حاضری، AI تخمینہ، وغیرہ) کو صوتی احکامات (जैसे 'Go to Inventory', 'Open Billing') کے ذریعے فوری تبدیل کیا جا سکے۔

### ۷. انوینٹری ڈائریکٹ پرائس ایڈیٹنگ، ویلیڈیشن اور مارجن بیجز (Inventory Direct Pricing & Deviation Badges)
- انوینٹری مینیجر میں کاسٹ اور سیل قیمتوں کی ڈائریکٹ ان لائن ایڈیٹنگ شامل کی گئی۔
- مثبت نمبرز (`>= 0`) کی سخت ویلیڈیشن نافذ کی گئی۔
- منافع کے مارجن اور قیمت کے تناسب کو ظاہر کرنے کے لیے بصری بیجز (`🚨 Loss`, `⚠️ Thin`, `🟢 Margin`, `⭐ Premium`) شامل کیے گئے۔

### ۸. جیمنی AI فوٹو پرائس لسٹ اور آٹو کیٹیگوریز (Gemini API Auto-Categorization & Pricing Tiers)
- موبائل سے کیپچر یا اپلوڈ کی گئی پرائس لسٹس اور رسیدوں کی تصاویر سے Gemini API کے ذریعے مصنوعات کی خودکار کیٹیگریز اور مقامی مارکیٹ کے مطابق آپٹمائزڈ قیمتوں کی تجاویز۔
