 ...
 * for Qumber Pipe & Sanitary Store (QumberSanitary).
 */
export const downloadPdfReceipt = (options: PdfReceiptOptions): boolean => {
  try {
    ...
    const footerText =
      ...
      "Thank you for choosing QumberSanitary! Building trust for your dream home.";
    ...
    doc.setFont("helvetica", "normal");
    doc.text(
      `Generated by QumberSanitary Billing System • ${new Date().toISOString().slice(0, 10)}`,
      pageWidth / 2,
      pageHeight - 4,
      { align: "center" }
    );
