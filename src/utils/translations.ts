...
export const translations = {
  ...
  items: { en: 'Items', ur: 'اشیاء', ps: 'توکي', mix: 'Items (اشیاء)' },
  ...
  super_admin_dashboard: { en: '👑 Super Admin HQ', ur: '👑 سپر ایڈمن مرکز', ps: '👑 د سوپر اډمین مرکز', mix: 'Super Admin HQ (سپر ایڈمن)' },
  branch_owner_dashboard: { en: '🏬 Branch Control', ur: '🏬 برانچ کنٹرول', ps: '🏬 د څانګې کنټرول', mix: 'Branch Control (برانچ کنٹرول)' },
  expense_ledger: { en: '📄 Expense Ledger', ur: '📄 کاروباری خرچہ شیٹ', ps: '📄 د لګښت کتاب', mix: 'Expense Ledger (خرچہ شیٹ)' },
  motion_security: { en: '📹 CCTV & Security', ur: '📹 کیمرہ و سیکیورٹی', ps: '📹 سیکیورٹی کمرې', mix: 'CCTV & Security (کیمرہ)' },
  staff_secret_hub: { en: '💬 Staff Chat Room', ur: '💬 برانچز سیکرٹ گروپ', ps: '💬 د کارمندانو کوټه', mix: 'Staff Chat (سیکرٹ گروپ)' },
  attendance: { en: '⏰ Attendance Register', ur: '⏰ حاضری رجسٹر', ps: '⏰ د حاضري کتاب', mix: 'Attendance (حاضری)' },
  ai_hub: { en: '🤖 AI Sales & Orders', ur: '🤖 اے آئی سیلز و آرڈرز', ps: '🤖 د AI پلور او فرمایشونه', mix: 'AI Sales (اے آئی سیلز)' },
  export: { en: '📦 Export & APK', ur: '📦 ڈیٹا ایکسپورٹ مینو', ps: '📦 د صادراتو مینو', mix: 'Export & APK (ایکسپورٹ)' },
  camera_hub_btn: { en: 'CCTV & Scan', ur: 'کیمرہ اور اسکین', ps: 'کمره او سکین', mix: 'CCTV & Scan (کیمرہ و سکین)' },
  today_sales: { en: 'Today\'s Sales', ur: 'آج کی فروخت', ps: 'د نن پلور', mix: 'Today\'s Sales (آج کی سیل)' },
  lock: { en: 'Lock', ur: 'ٹرمینل لاک', ps: 'بندول', mix: 'Lock (لاک)' },
  install_share: { en: 'Install / Share', ur: 'انسٹال اور شیئر', ps: 'انسٹال او شریکول', mix: 'Install / Share (انسٹال)' },
  print: { en: 'Print', ur: 'پرنٹ کریں', ps: 'چاپ کړئ', mix: 'Print (پرنٹ)' },
  return_item: { en: '↩️ Return Item', ur: '↩️ واپس کریں', ps: '↩️ بیرته راګرځول', mix: 'Return Item (واپسی)' },
  price_lists: { en: 'Price Lists & Guides', ur: 'پرائس لسٹ اور گائیڈز', ps: 'د قیمتونو لیستونه', mix: 'Price Lists (پرائس لسٹ)' },
  pprc_price_list: { en: 'Master PPRC Pipe Price List', ur: 'ماسٹر PPRC پائپ پرائس لسٹ', ps: 'د ماسټر PPRC قیمت لیست', mix: 'PPRC Price List (پائپ لسٹ)' },
  buj_price_list: { en: 'BUJ Sanitary Ware Price List', ur: 'BUJ سینیٹری ویئر پرائس لسٹ', ps: 'د BUJ سینٹری لوښو قیمت لیست', mix: 'BUJ Price List (سینیٹری لسٹ)' },
  view_interactive_list: { en: 'Interactive Price List', ur: 'انٹرایکٹو پرائس لسٹ', ps: 'انٹرایکٹو قیمت لیست', mix: 'Interactive List (انٹرایکٹو)' },
  official_pdf_download: { en: 'Download Official PDF', ur: 'آفیشل پی ڈی ایف ڈاؤن لوڈ', ps: 'رسمي پی ډی ایف ډاونلوډ کړئ', mix: 'Download PDF (پی ڈی ایف)' },
};
